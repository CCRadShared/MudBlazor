...
#nullable enable
    ...
    public class BreadcrumbItem
    {
        ...
        /// <summary>
        /// List of subitems for current BreadCrumbItem
        /// </summary>
        public List<BreadcrumbItem>? SubItems { get; }
        ...
        /// /// <param name="subItems">The subitems for the current BreadCrumbItem.</param>
        public BreadcrumbItem(string text, string? href, bool disabled = false, string? icon = null, List<BreadcrumbItem>? subItems = null)
        {
            Text = text;
            Disabled = disabled;
            Href = href;
